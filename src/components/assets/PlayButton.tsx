export default function PlayButton(props: { fillColor: string }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision"
            imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" fill={props.fillColor} viewBox="0 0 512 512">
